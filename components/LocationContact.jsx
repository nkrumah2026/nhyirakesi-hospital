    ...
    <section id="contact" className="py-12 md:py-16 bg-slate-50 border-t border-slate-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-14">
            ...
            {firstVisitSteps.map((stepItem, idx) => (
              <div key={idx} className="bg-slate-50 p-4 rounded-lg border border-slate-200 space-y-2">
                <div className="flex items-center justify-between">
                  <span className="text-xs font-semibold text-medical-blue bg-blue-50 px-2 py-0.5 rounded-md border border-blue-200">
                    Step {stepItem.step}
                  </span>
                </div>
                <h4 className="font-serif font-semibold text-slate-900 text-base">{stepItem.title}</h4>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start font-sans">
          ...
          <div className="lg:col-span-7 bg-white rounded-xl p-6 sm:p-8 border border-slate-200 shadow-2xs space-y-6">
            ...
            <div className="pt-2 border-t border-slate-200 flex flex-wrap gap-2.5">
              <a
                ...
                className="flex-1 min-w-[180px] inline-flex items-center justify-center gap-2 bg-emerald-600 hover:bg-emerald-700 text-white py-2.5 px-4 rounded-lg font-semibold text-xs shadow-2xs transition-colors"
              >
              ...
              <button
                ...
                className="inline-flex items-center justify-center gap-2 bg-medical-red hover:bg-medical-red-hover text-white py-2.5 px-4 rounded-lg font-semibold text-xs shadow-2xs transition-colors"
              >
          ...
          <div className="lg:col-span-5 bg-slate-900 rounded-xl p-6 text-white border border-slate-800 space-y-5 font-sans">
            ...
            <div className="space-y-2 pt-2 border-t border-slate-800">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-full inline-flex items-center justify-center gap-2 bg-medical-blue hover:bg-medical-blue-dark text-white py-2.5 px-4 rounded-lg font-semibold text-xs transition-colors"
              >
            ...
            {faqList.map((faq, idx) => (
              ...
              >
                <button
                  ...
                  className="w-full p-4 text-left flex items-center justify-between gap-4 font-semibold text-slate-900 hover:text-medical-blue text-sm sm:text-base"
                >
                ...
                {openFaq === idx && (
                  <div className="px-4 pb-4 text-slate-600 text-xs sm:text-sm leading-relaxed border-t border-slate-100 pt-2 font-sans">
                    {faq.answer}
                  </div>
                )}
              </div>
