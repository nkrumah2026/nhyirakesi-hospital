          ...
          {filteredItems.map((item) => (
            ...
            >
              ...
              <div className="relative h-56 w-full bg-slate-200 overflow-hidden">
                ...
                {/* Category Badge */}
                <div className="absolute top-3 left-3 bg-white/90 px-2.5 py-1 rounded-md border border-slate-200 text-[11px] font-bold text-slate-800 shadow-2xs">
                  {item.category}
                </div>
      ...
      {activeImage && (
        <div className="fixed inset-0 z-50 bg-slate-950/80 flex items-center justify-center p-4">
          <div className="relative max-w-3xl w-full bg-white border border-slate-200 rounded-xl overflow-hidden shadow-2xl">
            ...
            {/* Modal Details */}
            <div className="p-5 bg-white border-t border-slate-200 space-y-1.5">
              <div className="inline-flex items-center gap-1.5 text-emerald-700 text-xs font-bold uppercase">
