...
import { Stethoscope, Activity, Sparkles, Clock, ArrowRight } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        ...
        <div className="max-w-3xl space-y-2 text-left">
          ...
          <p className="text-slate-600 text-sm sm:text-base leading-relaxed font-sans">
            We offer medical consultations, non-surgical physical rehabilitation, traditional herbal care, and supportive wellness care tailored to your health needs.
          </p>
        </div>

        {/* Services Overview Grid - 4 Primary Categories */}
